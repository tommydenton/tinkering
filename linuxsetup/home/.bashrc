...
alias fire='sudo /usr/local/bin/fireout /var/log/syslog'
...
#i2cdetect
alias detect="i2cdetect -y 1"

# Show MOTD and the Command list
alias motd='cat /etc/motd'

# Python and CLOCK
alias atomic='sudo ntpd -gq'
alias sp="sudo python "
alais hw="sudo hwclock "

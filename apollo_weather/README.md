...
```bash
# Download the font
# Create the OpenType fonts directory if it doesn't exist
...
The script will auto-detect and use the NASA font if installed. Otherwise, it falls back to DejaVu Sans.
